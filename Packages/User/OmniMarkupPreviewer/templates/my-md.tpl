...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/public/my-md.css">
    <link rel="stylesheet" type="text/css" href="/public/zTree_v3/metroStyle.css">
  </head>
  <body>
    <div class="menu-box"><div id="menu" class="ztree"></div></div>
    <div class="container">
      <div id="markup">
  ...
  <script type="text/javascript" src="/public/zTree_v3/jquery.ztree.all.js"></script>
